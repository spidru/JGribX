 ...
 * @version 1.0
 */
class NotSupportedException(msg: String) : Exception(msg) {
	companion object {
		/** peg - Added default generated variable Default variable, that must be implemented, when extending Exception */
