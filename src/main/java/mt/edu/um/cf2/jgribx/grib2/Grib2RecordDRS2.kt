...
open class Grib2RecordDRS2 protected constructor(nDataPoints: Int,
												 ...
												 internal val missingValue: IntArray,
	...
	private constructor(drs0: Grib2RecordDRS0, splitMethod: Int, missingValueManagement: Int, missingValue: IntArray,
	...
	override fun writeTo(outputStream: GribOutputStream) {
		...
		outputStream.writeUInt(missingValue.getOrNull(0) ?: -1, bytes = 4) // [24-27]
		outputStream.writeUInt(missingValue.getOrNull(1) ?: -1, bytes = 4) // [28-31]
