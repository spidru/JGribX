...
class GribInputStream(inputStream: InputStream?, private val onRead: (Long) -> Unit = {}) : FilterInputStream(inputStream) {
	...
	private fun incrementByteCounters(increment: Number): Long {
	...
	override fun read(): Int {
		...
		bitCounter += 8
		onRead(incrementByteCounters(1))
		return value
	}

	override fun read(b: ByteArray): Int {
		// super.read(ByteArray) -> read(ByteArray, Int, Int) -> onRead(incrementByteCounters(read))
		return super.read(b)
	}
