   ...
   6-8		reserved (set to 0)
      */
      ...
      switch(this.grid_mode)
      {
         ...
         this.grid_dx = Bytes2Number.uint2(data[17] & 0x7F, data[18]) / 1000.0; // 0x7F to ignore leftmost bit

         // octets 26-27 (y increment)
         this.grid_dy = Bytes2Number.uint2(data[19] & 0x7F, data[20]) / 1000.0; // 0x7F to ignore leftmost bit
