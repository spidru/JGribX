...
import mt.edu.um.cf2.jgribx.GribPDSParamTable;
...
public class GribSummary
{
   ...
   private static class FldIter
   {
      ...
      {
         mLights = lights;
         mFldCmp = new GribFldComparator(new int[]{
            GribRecHeader.F_GDS, GribRecHeader.F_LEV_TYP, GribRecHeader.F_PAR,
            GribRecHeader.F_DATE, GribRecHeader.F_LEV_Z});
         TreeSet tree = new TreeSet(mFldCmp);
         ...
         mHds = (GribRecHeader[]) tree.toArray(new GribRecHeader[0]);
      }
