...
import mt.edu.um.cf2.jgribx.GribPDSLevel;
import mt.edu.um.cf2.jgribx.GribPDSParameter;
...
import mt.edu.um.cf2.jgribx.GribRecordPDS;
...
public class GribRecHeader implements Comparable {
    ...
    */
	public static final int mDefaultFldOrder[] = {F_GDS, F_LEV_TYP, F_PAR, F_DATE, F_LEV_Z};
